...
func _get_effect_name() -> String: return "Weakness"
func _get_description() -> String: return "Decrease all damage dealt by " + Global.percent_as_string(base) + "."

func _get_effect_color() -> Color: return Color(0.81, 0.267, 0.81, 1.0)
...
func _is_beneficial() -> bool: return false
